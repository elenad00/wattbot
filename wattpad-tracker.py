...
url = "https://www.wattpad.com/story/233493757-under-the-cover-of-darkness-g-r"
...
interactionscore = round(likes/reads*100, 0)
print(f'[+] Interaction Score: {interactionscore}')